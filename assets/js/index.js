...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _componentsMainIndex = __webpack_require__(9);
	...
	exports['default'] = {
		...
		data: function data() {
			return {
				...
				showTeam: false,
				bgStyle: {
					background: 'url(' + _libAssetsJs.imgs.bg + ') no-repeat center center',
		...
		methods: {
			...
			entryShare: function entryShare() {
				var _this = this;
				...
				setTimeout(function () {
					...
					if (!_this.desc) {
						_this.desc = _this.handType[Math.random() * _this.handType.length | 0];
					}
					...
					setTimeout(function () {
						...
						obserable.trigger({
							type: 'fillShare',
							data: {
								handImg: _this.handList[index].url,
								uploadImg: _this.uploadImg,
								job: _this.handList[index].name,
								myhandname: _this.desc
							}
						});
					}, 500);
				}, 1);
	   ...
	   console.log(this.bgStyle)*/
				...
				var classList = ['left1 ', 'left ', 'active ', 'right ', 'right1 '];
				...
				classList = ['left1 ', 'left transition1', 'active transition', 'right transition1', 'right1 '];

				if (!this.isLeft) {
					classList = ['left1 ', 'left transition1', 'active transition', 'right ', 'right1 '];
				}
	   	...
	   	backgroundSize:'cover'
				...
				var classList = ['left1 ', 'left transition1', 'active transition', 'right transition1', 'right1 '];
				if (this.isLeft) {
					classList = ['left1 ', 'left ', 'active transition', 'right transition1', 'right1 '];
				}
				handList.forEach(function (list, i) {
		...
		mounted: function mounted() {
			...
			window.onresize = function () {
				...
				if (window.innerHeight < _this2.viewH) {
					_this2.textareaStyle = {
						background: '#fff',
						height: '300px',
						width: '100%'
			...
			obserable.on('reupload', function () {
				_this2.handList[_this2.handList.length - 1].url = _this2.imgs.upload;
				_this2.uploadImg = '';
				_this2.show = true;
			});
			...
			obserable.on('hideInfo', function () {
				setTimeout(function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".lt-full {\r\n  width: 100%;\r\n  height: 100%;\r\n  position: absolute;\r\n  left: 0;\r\n  top: 0; }\r\n\r\n.zmiti-text-overflow {\r\n  overflow: hidden;\r\n  white-space: nowrap;\r\n  word-break: break-all;\r\n  text-overflow: ellipsis;\r\n  -webkit-text-overflow: ellipsis; }\r\n\r\n.zmiti-play {\r\n  width: .8rem;\r\n  height: .8rem;\r\n  border-radius: 50%;\r\n  position: fixed;\r\n  z-index: 1000;\r\n  right: .5rem;\r\n  top: .5rem; }\r\n  .zmiti-play.rotate {\r\n    -webkit-animation: rotate 5s linear infinite;\r\n    animation: rotate 5s linear infinite; }\r\n\r\n@-webkit-keyframes rotate {\r\n  to {\r\n    -webkit-transform: rotate(360deg);\r\n    transform: rotate(360deg); } }\r\n.zmiti-main-main-ui {\r\n  -webkit-transform-style: preserve-3d;\r\n  transform-style: preserve-3d;\r\n  perspective: 800px;\r\n  -webkit-perspective: 800px;\r\n  width: 750px;\r\n  -webkit-transform-style: preserve-3d;\r\n  transform-style: preserve-3d;\r\n  perspective: 800px;\r\n  -webkit-perspective: 800px; }\r\n  .zmiti-main-main-ui .zmiti-bg-mask {\r\n    z-index: 200; }\r\n    .zmiti-main-main-ui .zmiti-bg-mask:before {\r\n      display: none;\r\n      content: '';\r\n      position: absolute;\r\n      width: 100%;\r\n      height: 100%;\r\n      left: 0;\r\n      top: 0;\r\n      background: rgba(0, 0, 0, 0.5);\r\n      z-index: -1; }\r\n  .zmiti-main-main-ui .zmiti-bg.main-enter-active, .zmiti-main-main-ui .zmiti-bg.main-leave-active {\r\n    -webkit-transition: 1s;\r\n    transition: 1s; }\r\n  .zmiti-main-main-ui .zmiti-bg.main-enter, .zmiti-main-main-ui .zmiti-bg.main-leave-to {\r\n    opacity: 0; }\r\n  .zmiti-main-main-ui .zmiti-hand-page {\r\n    -webkit-transform-origin: center 90%;\r\n    transform-origin: center 90%; }\r\n    .zmiti-main-main-ui .zmiti-hand-page.hand-enter-active, .zmiti-main-main-ui .zmiti-hand-page.hand-leave-active {\r\n      -webkit-transition: 1s 0.5s;\r\n      transition: 1s 0.5s; }\r\n    .zmiti-main-main-ui .zmiti-hand-page.hand-enter, .zmiti-main-main-ui .zmiti-hand-page.hand-leave-to {\r\n      opacity: 0; }\r\n    .zmiti-main-main-ui .zmiti-hand-page.left {\r\n      opacity: 1;\r\n      -webkit-transform: translate3d(-5.66667rem, 0, 0) scale(0.3);\r\n      transform: translate3d(-5.66667rem, 0, 0) scale(0.3);\r\n      z-index: 199; }\r\n    .zmiti-main-main-ui .zmiti-hand-page.transition {\r\n      -webkit-transition: -webkit-transform 0.5s;\r\n      transition: transform 0.5s; }\r\n    .zmiti-main-main-ui .zmiti-hand-page.transition1 {\r\n      -webkit-transition: -webkit-transform 0.3s 0.1s;\r\n      transition: transform 0.3s 0.1s; }\r\n    .zmiti-main-main-ui .zmiti-hand-page.left1 {\r\n      z-index: -1;\r\n      -webkit-transform: translate3d(-750px, 0, 0) scale(0.3);\r\n      transform: translate3d(-750px, 0, 0) scale(0.3); }\r\n    .zmiti-main-main-ui .zmiti-hand-page.right {\r\n      opacity: 1;\r\n      -webkit-transform: translate3d(5.66667rem, 0, 0) scale(0.3);\r\n      transform: translate3d(5.66667rem, 0, 0) scale(0.3);\r\n      z-index: 199; }\r\n    .zmiti-main-main-ui .zmiti-hand-page.right1 {\r\n      z-index: -1;\r\n      -webkit-transform: translate3d(750px, 0, 0) scale(0.3);\r\n      transform: translate3d(750px, 0, 0) scale(0.3); }\r\n    .zmiti-main-main-ui .zmiti-hand-page.active {\r\n      -webkit-transform: rotateY(0);\r\n      transform: rotateY(0);\r\n      z-index: 201; }\r\n  .zmiti-main-main-ui .zmiti-hand-bg {\r\n    position: absolute;\r\n    width: 750px;\r\n    left: 0;\r\n    top: 0;\r\n    height: 80vh;\r\n    /* -webkit-filter:blur(8px);\r\n    filter:blur(8px); */ }\r\n    .zmiti-main-main-ui .zmiti-hand-bg:before {\r\n      display: none;\r\n      content: '';\r\n      position: absolute;\r\n      left: 0;\r\n      top: 0;\r\n      z-index: 10;\r\n      width: 100%;\r\n      height: 100%;\r\n      background: rgba(47, 7, 8, 0.56); }\r\n  .zmiti-main-main-ui .zmiti-img-desc {\r\n    position: absolute;\r\n    bottom: 5%;\r\n    left: 0%;\r\n    height: 40px;\r\n    width: 100%;\r\n    color: #912426;\r\n    line-height: 40px;\r\n    text-align: center;\r\n    box-sizing: box-sizing; }\r\n    .zmiti-main-main-ui .zmiti-img-desc textarea {\r\n      color: #912426;\r\n      outline: none;\r\n      width: 80%;\r\n      height: 100%;\r\n      background: transparent;\r\n      font-size: 28px;\r\n      vertical-align: bottom;\r\n      border: none;\r\n      border-bottom: 1px solid #912426;\r\n      border-radius: 0;\r\n      resize: none; }\r\n  .zmiti-main-main-ui .zmiti-info {\r\n    position: absolute;\r\n    width: 80px;\r\n    z-index: 300;\r\n    left: 50%;\r\n    top: 50%;\r\n    -webkit-animation: move 1s infinite linear;\r\n    animation: move 1s infinite linear; }\r\n@-webkit-keyframes move {\r\n  to {\r\n    -webkit-transform: translate3d(-100px, 0, 0);\r\n    transform: translate3d(-100px, 0, 0); } }\r\n  .zmiti-main-main-ui .zmiti-hand-img {\r\n    position: absolute;\r\n    z-index: 10;\r\n    height: 90%;\r\n    -webkit-transform: translate3d(-50%, 0, 0);\r\n    transform: translate3d(-50%, 0, 0);\r\n    left: 50%;\r\n    top: 2vh;\r\n    z-index: 22; }\r\n    .zmiti-main-main-ui .zmiti-hand-img canvas {\r\n      position: absolute;\r\n      left: 5%;\r\n      top: 3%;\r\n      z-index: 100; }\r\n    .zmiti-main-main-ui .zmiti-hand-img img.zmiti-img-bg {\r\n      opacity: 0;\r\n      height: 100%;\r\n      width: auto; }\r\n    .zmiti-main-main-ui .zmiti-hand-img .zmiti-hand {\r\n      position: absolute;\r\n      top: 0;\r\n      left: 0;\r\n      width: 90%;\r\n      left: 5%;\r\n      top: 3%;\r\n      height: 80%; }\r\n      .zmiti-main-main-ui .zmiti-hand-img .zmiti-hand img {\r\n        border-radius: 10px; }\r\n      .zmiti-main-main-ui .zmiti-hand-img .zmiti-hand .zmiti-hand-text {\r\n        position: absolute;\r\n        background: rgba(0, 0, 0, 0.4);\r\n        bottom: -25px;\r\n        padding: 20px;\r\n        left: 0;\r\n        color: #fff;\r\n        font-size: 26px;\r\n        width: 93%;\r\n        border-radius: 10px; }\r\n        .zmiti-main-main-ui .zmiti-hand-img .zmiti-hand .zmiti-hand-text section {\r\n          width: 100%;\r\n          text-align: right;\r\n          font-weight: bold; }\r\n      .zmiti-main-main-ui .zmiti-hand-img .zmiti-hand input {\r\n        position: absolute;\r\n        opacity: 0;\r\n        z-index: 10;\r\n        width: 100%;\r\n        height: 100%;\r\n        left: 0;\r\n        top: 0; }\r\n      .zmiti-main-main-ui .zmiti-hand-img .zmiti-hand .zmiti-upload-status {\r\n        background: #ababa8;\r\n        color: #912426;\r\n        font-weight: bold;\r\n        text-align: center; }\r\n        .zmiti-main-main-ui .zmiti-hand-img .zmiti-hand .zmiti-upload-status span {\r\n          border: 1px solid red;\r\n          position: absolute;\r\n          left: 50%;\r\n          -webkit-transform: translate3d(-50%, 0, 0);\r\n          transform: translate3d(-50%, 0, 0); }\r\n    .zmiti-main-main-ui .zmiti-hand-img .zmiti-subtitle {\r\n      position: absolute;\r\n      left: 5%;\r\n      bottom: 4%; }\r\n    .zmiti-main-main-ui .zmiti-hand-img .zmiti-name {\r\n      position: absolute;\r\n      bottom: 40px;\r\n      right: 5%;\r\n      color: #912426;\r\n      font-weight: bold; }\r\n      .zmiti-main-main-ui .zmiti-hand-img .zmiti-name span {\r\n        font-size: 46px; }\r\n      .zmiti-main-main-ui .zmiti-hand-img .zmiti-name img {\r\n        width: 60px;\r\n        border-radius: 50%;\r\n        vertical-align: bottom; }\r\n  .zmiti-main-main-ui .zmiti-ok {\r\n    position: absolute;\r\n    height: 60px;\r\n    width: 240px;\r\n    border-radius: 10px;\r\n    bottom: 26px;\r\n    background: #912426;\r\n    color: #ffe3a6;\r\n    text-align: center;\r\n    line-height: 60px;\r\n    left: 50%;\r\n    margin-left: -120px;\r\n    z-index: 215; }\r\n    .zmiti-main-main-ui .zmiti-ok span {\r\n      position: absolute;\r\n      width: 100%;\r\n      height: 100%;\r\n      left: 0;\r\n      top: 0;\r\n      line-height: 2.2;\r\n      font-size: 34px; }\r\n  .zmiti-main-main-ui .zmiti-year {\r\n    position: absolute;\r\n    width: 80%;\r\n    height: 60px;\r\n    z-index: 20;\r\n    bottom: 20px;\r\n    left: 10%;\r\n    text-align: center;\r\n    color: #bebbba;\r\n    font-size: 30px;\r\n    font-family: Georgia; }\r\n    .zmiti-main-main-ui .zmiti-year:before, .zmiti-main-main-ui .zmiti-year:after {\r\n      content: '';\r\n      position: absolute;\r\n      left: 0;\r\n      top: 23px;\r\n      height: 2px;\r\n      background: -webkit-gradient(linear, left top, right top, from(rgba(190, 187, 186, 0.2)), color-stop(0.5, #bebbba), to(rgba(190, 187, 186, 0.2)));\r\n      width: 35%; }\r\n    .zmiti-main-main-ui .zmiti-year:after {\r\n      right: 0;\r\n      left: auto; }\r\n\r\n.load-3 {\r\n  margin-top: 50%;\r\n  padding-bottom: 20px; }\r\n\r\n.k-line2 {\r\n  display: inline-block;\r\n  background: #666;\r\n  height: 10px;\r\n  width: 10px;\r\n  opacity: 0;\r\n  border-radius: 50%;\r\n  transform: translateX(-300px);\r\n  background-color: #912426; }\r\n\r\n.k-line12-1 {\r\n  animation: k-loadingS 3s infinite;\r\n  animation-delay: 0.8s; }\r\n\r\n.k-line12-2 {\r\n  animation: k-loadingS 3s infinite;\r\n  animation-delay: 0.7s; }\r\n\r\n.k-line12-3 {\r\n  animation: k-loadingS 3s infinite;\r\n  animation-delay: 0.6s; }\r\n\r\n.k-line12-4 {\r\n  animation: k-loadingS 3s infinite;\r\n  animation-delay: 0.5s; }\r\n\r\n.k-line12-5 {\r\n  animation: k-loadingS 3s infinite;\r\n  animation-delay: 0.4s; }\r\n\r\n.k-line12-6 {\r\n  animation: k-loadingS 3s infinite;\r\n  animation-delay: 0.3s; }\r\n\r\n.k-line12-7 {\r\n  animation: k-loadingS 3s infinite;\r\n  animation-delay: 0.2s; }\r\n\r\n.k-line12-8 {\r\n  animation: k-loadingS 3s infinite;\r\n  animation-delay: 0.1s; }\r\n\r\n@keyframes k-loadingS {\r\n  40% {\r\n    transform: translateX(0);\r\n    opacity: 0.8; }\r\n  100% {\r\n    transform: translateX(300px);\r\n    opacity: 0; } }\r\n@media all and (min-width: 750px) and (min-height: 1440px) {\r\n  .zmiti-main-main-ui .zmiti-hand-img {\r\n    height: 74vh;\r\n    top: 12vh; } }\r\n\r\n/*# sourceMappingURL=index.css.map */\r\n", ""]);
	...
	exports['default'] = {
		...
		data: function data() {
			return {
				...
				handImg: '',
				job: '',
				headimgurl: _libAssetsJs.imgs.logo,
				myhandname: '网友'
		...
		mounted: function mounted() {
	  	...
	  	this.html2img();
			...
			obserable.on('fillShare', function (data) {
				_this2.show = true;
				_this2.handImg = data.handImg;
				_this2.uploadImg = data.uploadImg;
				_this2.job = data.job;
				_this2.myhandname = data.myhandname;
				_this2.headimgurl = window.headimgurl || _this2.imgs.logo;
				_this2.backgroundSize = 'cover';

				var url = window.location.href.split('#')[0];

				url = _libUtil2['default'].changeURLPar(url, 'src', _this2.uploadImg);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var zmitiUtil = {
		...
		wxConfig: function wxConfig(title, desc, url) {
			...
			_jquery2["default"].ajax({
				type: 'get',
				url: window.protocol + "//h5.zhongguowangshi.com/tree/weixin/jssdk.php?type=signature&durl=" + code_durl + '&worksid=' + window.customid,
				dataType: 'jsonp',
				jsonp: "callback",
		...
		methods: {
			...
			initPoints: function initPoints() {
				...
				var render = function render() {
					...
					_this3.zIndex > -1 && animationFrame(render);
				};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".lt-full {\r\n  width: 100%;\r\n  height: 100%;\r\n  position: absolute;\r\n  left: 0;\r\n  top: 0; }\r\n\r\n.zmiti-text-overflow {\r\n  overflow: hidden;\r\n  white-space: nowrap;\r\n  word-break: break-all;\r\n  text-overflow: ellipsis;\r\n  -webkit-text-overflow: ellipsis; }\r\n\r\n.zmiti-play {\r\n  width: .8rem;\r\n  height: .8rem;\r\n  border-radius: 50%;\r\n  position: fixed;\r\n  z-index: 1000;\r\n  right: .5rem;\r\n  top: .5rem; }\r\n  .zmiti-play.rotate {\r\n    -webkit-animation: rotate 5s linear infinite;\r\n    animation: rotate 5s linear infinite; }\r\n\r\n@-webkit-keyframes rotate {\r\n  to {\r\n    -webkit-transform: rotate(360deg);\r\n    transform: rotate(360deg); } }\r\n.zmiti-index-main-ui {\r\n  overflow: hidden;\r\n  width: 10rem;\r\n  left: 50% !important;\r\n  margin-left: -375px;\r\n  background: #f1ebcb;\r\n  opacity: 0;\r\n  z-index: 10;\r\n  -webkit-transition: 1s;\r\n  transition: 1s; }\r\n  .zmiti-index-main-ui.show {\r\n    opacity: 1; }\r\n  .zmiti-index-main-ui .zmiti-bg.main-enter-active, .zmiti-index-main-ui .zmiti-bg.main-leave-active {\r\n    -webkit-transition: 1s;\r\n    transition: 1s; }\r\n  .zmiti-index-main-ui .zmiti-bg.main-enter, .zmiti-index-main-ui .zmiti-bg.main-leave-to {\r\n    opacity: 0; }\r\n  .zmiti-index-main-ui .zmiti-hand-page {\r\n    -webkit-transform-origin: center 90%;\r\n    transform-origin: center 90%; }\r\n    .zmiti-index-main-ui .zmiti-hand-page.hand-enter-active, .zmiti-index-main-ui .zmiti-hand-page.hand-leave-active {\r\n      -webkit-transition: 1s 0.5s;\r\n      transition: 1s 0.5s; }\r\n    .zmiti-index-main-ui .zmiti-hand-page.hand-enter, .zmiti-index-main-ui .zmiti-hand-page.hand-leave-to {\r\n      opacity: 0; }\r\n    .zmiti-index-main-ui .zmiti-hand-page.left {\r\n      opacity: 1;\r\n      -webkit-transform: translate3d(-5.66667rem, 0, 0) scale(0.3);\r\n      transform: translate3d(-5.66667rem, 0, 0) scale(0.3);\r\n      z-index: 200; }\r\n    .zmiti-index-main-ui .zmiti-hand-page.transition {\r\n      -webkit-transition: -webkit-transform 0.5s;\r\n      transition: transform 0.5s; }\r\n    .zmiti-index-main-ui .zmiti-hand-page.transition1 {\r\n      -webkit-transition: -webkit-transform 0.3s 0.1s;\r\n      transition: transform 0.3s 0.1s; }\r\n    .zmiti-index-main-ui .zmiti-hand-page.left1 {\r\n      z-index: -1;\r\n      -webkit-transform: translate3d(-750px, 0, 0) scale(0.3);\r\n      transform: translate3d(-750px, 0, 0) scale(0.3); }\r\n    .zmiti-index-main-ui .zmiti-hand-page.right {\r\n      opacity: 1;\r\n      -webkit-transform: translate3d(5.66667rem, 0, 0) scale(0.3);\r\n      transform: translate3d(5.66667rem, 0, 0) scale(0.3);\r\n      z-index: 200; }\r\n    .zmiti-index-main-ui .zmiti-hand-page.right1 {\r\n      z-index: -1;\r\n      -webkit-transform: translate3d(750px, 0, 0) scale(0.3);\r\n      transform: translate3d(750px, 0, 0) scale(0.3); }\r\n    .zmiti-index-main-ui .zmiti-hand-page.active {\r\n      -webkit-transform: rotateY(0);\r\n      transform: rotateY(0);\r\n      z-index: 201; }\r\n  .zmiti-index-main-ui .zmiti-hand-img {\r\n    position: absolute;\r\n    z-index: 10;\r\n    height: 90%;\r\n    -webkit-transform: translate3d(-50%, 0, 0);\r\n    transform: translate3d(-50%, 0, 0);\r\n    left: 50%;\r\n    top: 2vh;\r\n    z-index: 22; }\r\n    .zmiti-index-main-ui .zmiti-hand-img canvas {\r\n      position: absolute;\r\n      left: 5%;\r\n      top: 3%;\r\n      z-index: 100; }\r\n    .zmiti-index-main-ui .zmiti-hand-img img.zmiti-img-bg {\r\n      opacity: 0;\r\n      height: 100%;\r\n      width: auto; }\r\n    .zmiti-index-main-ui .zmiti-hand-img .zmiti-hand {\r\n      position: absolute;\r\n      top: 0;\r\n      left: 0;\r\n      width: 90%;\r\n      left: 5%;\r\n      top: 3%; }\r\n      .zmiti-index-main-ui .zmiti-hand-img .zmiti-hand img {\r\n        border-radius: 10px; }\r\n      .zmiti-index-main-ui .zmiti-hand-img .zmiti-hand input {\r\n        position: absolute;\r\n        opacity: 0;\r\n        z-index: 10;\r\n        width: 100%;\r\n        height: 100%;\r\n        left: 0;\r\n        top: 0; }\r\n      .zmiti-index-main-ui .zmiti-hand-img .zmiti-hand .zmiti-upload-status {\r\n        background: #ababa8;\r\n        color: #912426;\r\n        font-weight: bold;\r\n        text-align: center; }\r\n        .zmiti-index-main-ui .zmiti-hand-img .zmiti-hand .zmiti-upload-status span {\r\n          border: 1px solid red;\r\n          position: absolute;\r\n          left: 50%;\r\n          -webkit-transform: translate3d(-50%, 0, 0);\r\n          transform: translate3d(-50%, 0, 0); }\r\n    .zmiti-index-main-ui .zmiti-hand-img .zmiti-subtitle {\r\n      position: absolute;\r\n      left: 5%;\r\n      bottom: 3%; }\r\n    .zmiti-index-main-ui .zmiti-hand-img .zmiti-name {\r\n      position: absolute;\r\n      bottom: 40px;\r\n      right: 5%;\r\n      color: #912426;\r\n      font-weight: bold; }\r\n      .zmiti-index-main-ui .zmiti-hand-img .zmiti-name span {\r\n        font-size: 60px; }\r\n  .zmiti-index-main-ui .zmiti-hand-bg {\r\n    position: absolute;\r\n    width: 750px;\r\n    left: 0;\r\n    top: 0;\r\n    height: 100vh; }\r\n    .zmiti-index-main-ui .zmiti-hand-bg:before {\r\n      content: '';\r\n      display: none;\r\n      position: absolute;\r\n      left: 0;\r\n      top: 0;\r\n      z-index: 10;\r\n      width: 100%;\r\n      height: 100%;\r\n      background: rgba(47, 7, 8, 0.56); }\r\n  .zmiti-index-main-ui .zmiti-title {\r\n    position: absolute;\r\n    top: 2%;\r\n    width: 90%;\r\n    -webkit-transform: translate3d(-50%, 0, 0);\r\n    transform: translate3d(-50%, 0, 0);\r\n    left: 50%; }\r\n  .zmiti-index-main-ui .zmiti-start {\r\n    width: 240px;\r\n    height: 60px;\r\n    line-height: 60px;\r\n    border-radius: 10px;\r\n    text-align: center;\r\n    color: #ffe3a6;\r\n    position: absolute;\r\n    bottom: 6%;\r\n    left: 50%;\r\n    -webkit-transform: translate3d(-50%, 0, 0);\r\n    transform: translate3d(-50%, 0, 0); }\r\n    .zmiti-index-main-ui .zmiti-start span {\r\n      position: absolute;\r\n      width: 100%;\r\n      height: 100%;\r\n      left: 0;\r\n      top: 0;\r\n      line-height: 2.1;\r\n      font-size: 36px; }\r\n\r\n@-webkit-keyframes rotate1 {\r\n  to {\r\n    -webkit-transform: rotate(360deg) scale(2);\r\n    transform: rotate(360deg) scale(2);\r\n    opacity: 0; } }\r\n.zmiti-loading {\r\n  z-index: 1000; }\r\n  .zmiti-loading .zmiti-loading-ui {\r\n    width: 6rem;\r\n    left: 2rem;\r\n    position: absolute;\r\n    top: 6rem; }\r\n    .zmiti-loading .zmiti-loading-ui .zmiti-loading-bar {\r\n      width: 2rem;\r\n      border-radius: 10px;\r\n      position: relative;\r\n      margin: 0 auto; }\r\n      .zmiti-loading .zmiti-loading-ui .zmiti-loading-bar:before {\r\n        content: '';\r\n        border-radius: 10px;\r\n        position: absolute;\r\n        left: 0;\r\n        top: 0;\r\n        width: 100%;\r\n        height: 100%;\r\n        box-shadow: 0 0 3px rgba(255, 255, 255, 0.5); }\r\n      .zmiti-loading .zmiti-loading-ui .zmiti-loading-bar .zmiti-target {\r\n        width: 0.4rem;\r\n        height: 0.4rem;\r\n        border-radius: 50%;\r\n        background: #fff;\r\n        left: 50%;\r\n        top: .4rem;\r\n        position: absolute;\r\n        margin-left: -0.2rem;\r\n        -webkit-animation: scale linear 2s infinite alternate;\r\n        animation: scale linear 2s infinite alternate; }\r\n    .zmiti-loading .zmiti-loading-ui .zmiti-progress {\r\n      margin-top: .5rem;\r\n      text-align: center;\r\n      color: #fff;\r\n      font-family: Georgia;\r\n      font-size: .7rem; }\r\n\r\n@media all and (min-width: 750px) and (min-height: 1440px) {\r\n  .zmiti-index-main-ui .zmiti-hand-img {\r\n    height: 74vh;\r\n    top: 12vh; } }\r\n\r\n/*# sourceMappingURL=index.css.map */\r\n", ""]);
